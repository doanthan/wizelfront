...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 right-0 z-[100] flex max-h-screen w-full flex-col p-4 sm:top-4 sm:right-4 sm:w-auto md:max-w-[420px]",
      className
    )}
    {...props}
  />
  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-2 overflow-hidden rounded-lg border p-4 pr-6 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full",
  {
    variants: {
      variant: {
        ...
        destructive:
          "destructive group border-red-600/20 bg-red-600 text-white",
        success:
          "border-green-500/20 bg-green-500 text-white",
        info:
          "border-sky-blue/20 bg-sky-blue text-white",
        gradient:
          "border-vivid-violet/20 bg-gradient-to-r from-sky-blue to-vivid-violet text-white",
      },
    },
    defaultVariants: {
      variant: "default",
...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors hover:bg-secondary focus:outline-none focus:ring-1 focus:ring-ring disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-red-100/40 group-[.destructive]:hover:border-red-600/30 group-[.destructive]:hover:bg-red-600/90 group-[.destructive]:hover:text-white group-[.destructive]:focus:ring-red-600",
      className
    )}
    {...props}
  />
