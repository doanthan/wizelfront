 ...
 * @returns {Object} Client configuration with bound methods
 */
...
export const KlaviyoFilter = createKlaviyoFilter;
...
export const klaviyoOperations = {
   ...
   * @param {Object} client - Klaviyo client
...
const klaviyoHelpers = {
  createKlaviyoClient,
  createKlaviyoFilter,
  KlaviyoFilter, // Backward compatibility
  formatDateTime,
  klaviyoOperations,
  klaviyoBatch
};

export default klaviyoHelpers;